...
const NavBar = () => {
  ...
  //   ban dau active empty
  // truyen vao opt messsages
  // -> setActive messages
  // -> active = messages

  // tiep theo truyen vao opt messages
  // -> active = messages
  // -> setActive tro ve empty
  ...
  return (
    <header
      className={`header-section ${windowHeight > 100 && "header-fixed"}`}
    >
