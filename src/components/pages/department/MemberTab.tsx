...
import { apiResquest, apiURL, getAllAccount } from "../../../redux/apiRequest";
...
const MemberTab = ({ managers, members, groupId }: any) => {
  ...
  const fetchAllUsers = async () => {
    const res = await getAllAccount(dispatch, toast, navigate);
  ...
  const removeMemberHandler = async (username: any) => {
    ...
    const url = ` ${apiURL.groups}/${groupId}/members`;
